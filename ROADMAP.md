...
- [x] **[#42](https://github.com/umran666/UniqToken/issues/42)** [P0-critical] Full native batch pipeline in Rust to eliminate PyO3 FFI boundary overhead. (Closed on GitHub)
...
- [x] **[#22](https://github.com/umran666/UniqToken/issues/22)** [P1-high] C-ABI shared library export (libuniqtoken.so / .dll / .dylib) and C/C++ header (uniqtoken.h). (Closed on GitHub)
- [x] **[#33](https://github.com/umran666/UniqToken/issues/33)** [P1-high] Zero-copy PyBuffer borrowing in Rust batch encoder. (Closed on GitHub)
...
- [x] **[#27](https://github.com/umran666/UniqToken/issues/27)** `[P1-high]` vLLM custom tokenizer backend plugin and streaming worker. (Closed on GitHub)
...
- [x] **[#23](https://github.com/umran666/UniqToken/issues/23)** `[P2-medium]` Expand evaluation corpora with low-resource African and Indic languages. (Closed on GitHub)
...
4. **Pass the CI Matrix**: All PRs must pass the nine Python cells (3.10–3.12 across Ubuntu, macOS, and Windows) plus the Rust and native-wheel jobs, with no Clippy or Ruff failures.
